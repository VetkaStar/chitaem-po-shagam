      ...
      >
        <DialogContent className="parent-dialog">
          ...
          <div className="parent-info">
            ...
            <p>
              Буквы и слоги следуют выбранному набору. В разделе «Слова» —
              отдельный набор первых слов, включая ещё не изученные буквы;
              помогайте с ними. В новом занятии порядок перемешивается,
